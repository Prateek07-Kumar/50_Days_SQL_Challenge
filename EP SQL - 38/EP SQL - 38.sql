...
INSERT INTO Employees9 (Emp_No, Emp_Name, Job_Name, Manager_Id, HireDate, Salary, Commission, Department) VALUES
...
select Emp_Name,
	   Salary,
	   Department
from Employees9 as e1
where Salary > (select avg(salary) from Employees9 as e2
...
select 
	   ...
	   Department
from Employees9
where Salary < (select avg(salary) from Employees9); 
